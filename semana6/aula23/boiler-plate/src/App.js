...
class App extends React.Component {
  ...
  componentDidUpdate() {
    localStorage.setItem("novas tarefas",JSON.stringify(this.state.tarefas))
  };

  componentDidMount() {
    if(localStorage.getItem("novas tarefas")) {
      const tarefaString = localStorage.getItem("novas tarefas")
